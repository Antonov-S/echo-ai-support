      ...
      messages: [
        {
          ...
          content: [
            ...
            {
              type: "text",
              text: "Extract the text and print it in a markdown format, without any explanation."
            }
          ]
        }
      ]
    ...
    messages: [
      {
        ...
        content: [
          ...
          {
            type: "text",
            text: "Extract the text from the PDF and print it directly, without any explanation."
          }
        ]
      }
    ]
